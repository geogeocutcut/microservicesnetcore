...
import org.modelio.microservicesnetcore.psm.generator.orchestrator.GenerateServiceProjectCodeOrchestrator;
import org.modelio.vcore.smkernel.mapi.MObject;

public class GenerateServiceProjetCodeCommand extends DefaultModuleCommandHandler {
    /**
     * Constructor.
     */
    public GenerateServiceProjetCodeCommand() {
        super();
    }
    ...
    public boolean accept(List<MObject> selectedElements, IModule module) {
    	...
    	for(MObject elt :  selectedElements)
    	{
    		...
    		if(!PsmStereotypeValidator.IsPsmServicePackage((Package)elt))
    		{
    			return false;
    		}
    	}
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try{
	        ...
	        {
		        GenerateServiceProjectCodeOrchestrator serviceOrchest = new GenerateServiceProjectCodeOrchestrator(module);
		        serviceOrchest.Execute(e);
        ...
        MessageDialog.openInformation(null, "Information", ".net Service Projects (interface, impl) has been generated !");
    }
