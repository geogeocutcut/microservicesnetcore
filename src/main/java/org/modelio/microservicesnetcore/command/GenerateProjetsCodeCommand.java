...
import org.modelio.microservicesnetcore.psm.generator.orchestrator.GenerateProjectsCodeOrchestrator;
import org.modelio.vcore.smkernel.mapi.MObject;

public class GenerateProjetsCodeCommand extends DefaultModuleCommandHandler {
    /**
     * Constructor.
     */
    public GenerateProjetsCodeCommand() {
        super();
    }
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        try{
	        ...
	        {
	        	GenerateProjectsCodeOrchestrator orchestModel = new GenerateProjectsCodeOrchestrator(module);
        ...
        MessageDialog.openInformation(null, "Information", ".net Projects have been generated !");
    }
