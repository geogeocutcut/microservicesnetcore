...
import org.modelio.microservicesnetcore.psm.generator.handler.GeneratePsmRepositoryHandler;
import org.modelio.microservicesnetcore.helper.PimPsmMapper;
import org.modelio.microservicesnetcore.helper.PsmBuilder;

public class GeneratePsmRepositoryOrchestrator {
	...
	public GeneratePsmRepositoryOrchestrator(IModule module)
	{
	...
	public void Execute(MObject selectedPimMicroservice) 
	{
		if(_umlPimPackage!=null)
		{
			...
			GeneratePsmRepositoryHandler handler =new GeneratePsmRepositoryHandler(_module, (Package)psmMicroservice);
