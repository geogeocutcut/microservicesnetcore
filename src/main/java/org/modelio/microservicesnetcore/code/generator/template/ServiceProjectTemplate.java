...
public class ServiceProjectTemplate {
	private String _header= "org/modelio/microservicesnetcore/template/04 - service/impl/header.txt";
	...
	private String _csproj = "org/modelio/microservicesnetcore/template/04 - service/impl/csproj.txt";
	
	private String _applicationName;
	private Package _domain;
	
	public ServiceProjectTemplate(String applicationName, Package domain) {
		_domain=domain;
	...
	public String getCsProj() {
		...
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_csproj);
	...
	public String getHeader(Classifier visited,Classifier entity) {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_header);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getOperation(Operation visited) {
		...
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(opeHeader);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
		...
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_opeparameter);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_asyncopestart);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_asyncopeend);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getEnd() {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = ServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_end);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
