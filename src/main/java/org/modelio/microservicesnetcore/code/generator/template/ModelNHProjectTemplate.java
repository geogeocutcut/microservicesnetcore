...
public class ModelNHProjectTemplate implements InterfaceModelProjectTemplate {
	private String _header= "org/modelio/microservicesnetcore/template/01 - model/nhibernate/header.txt";
	private String _end = "org/modelio/microservicesnetcore/template/00 - common/end.txt";
	private String _attribute = "org/modelio/microservicesnetcore/template/01 - model/nhibernate/attribute.txt";
	private String _onetomany = "org/modelio/microservicesnetcore/template/01 - model/nhibernate/onetomany.txt";
	...
	public ModelNHProjectTemplate(String applicationName, Package domain) {
