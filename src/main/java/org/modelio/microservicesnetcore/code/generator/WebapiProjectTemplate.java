...
public class WebapiProjectTemplate {
	...
	private String _csproj = "org/modelio/microservicesnetcore/template/05 - webapi/csproj.txt";
	private String _iocregister = "org/modelio/microservicesnetcore/template/05 - webapi/iocregister.txt";
	private String _startup = "org/modelio/microservicesnetcore/template/05 - webapi/Startup.txt";
	...
	public WebapiProjectTemplate(String applicationName, Package domain) {
		_domain=domain;
	...
	public String getCsProj() {
		...
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_csproj);
	...
	public String getHeader(Classifier visited,Classifier entity) {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_header);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getOperation(Operation visited) {
		...
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(opeHeader);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
		...
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_opeparameter);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_asyncopestart);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_asyncopeend);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getEnd() {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_end);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public Object getStartupCs(List<String> services) {
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_startup);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public Object getProgramCs() {
		...
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = WebapiProjectTemplate.class.getClassLoader().getResourceAsStream(_program);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
