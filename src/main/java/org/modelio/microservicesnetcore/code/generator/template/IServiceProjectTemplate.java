...
public class IServiceProjectTemplate {
	private String _header= "org/modelio/microservicesnetcore/template/04 - service/interface/header.txt";
	...
	private String _csproj = "org/modelio/microservicesnetcore/template/04 - service/interface/csproj.txt";
	
	private String _applicationName;
	private Package _domain;
	
	public IServiceProjectTemplate(String applicationName, Package domain) {
	...
	public String getCsProj() {
		...
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_csproj);
	...
	public String getHeader(Classifier visited,Classifier entity) {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_header);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getOperation(Operation visited) {
		...
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(opeHeader);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
		...
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_opeparameter);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine());
			}
		...
		tmpl = new StringBuilder();
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_asyncopeend);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
	...
	public String getEnd() {
		StringBuilder tmpl = new StringBuilder();
		try {
			InputStream stream = IServiceProjectTemplate.class.getClassLoader().getResourceAsStream(_end);
			BufferedReader  reader = new BufferedReader (new InputStreamReader(stream, Charset.forName("UTF-8")));
			while (reader.ready()) {
				tmpl.append(reader.readLine()).append("\n");
			}
