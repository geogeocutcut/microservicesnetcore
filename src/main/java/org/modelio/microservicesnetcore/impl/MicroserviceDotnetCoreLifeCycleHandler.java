 ...
 */
public class MicroserviceDotnetCoreLifeCycleHandler extends DefaultModuleLifeCycleHandler {

	/**
	 * Constructor.
	 * @param module the Module this life cycle handler is instanciated for.
	 */
	public MicroserviceDotnetCoreLifeCycleHandler(MicroserviceDotnetCoreModule module) {
		super(module);
	}
