package org.modelio.microservicesnetcore.impl;
 ...
 * 
 */
public class MicroserviceDotnetCoreModule extends AbstractJavaModule {

	private MicroserviceDotnetCorePeerModule peerModule = null;

	private MicroserviceDotnetCoreLifeCycleHandler lifeCycleHandler = null;
	
	private static MicroserviceDotnetCoreModule instance;

	public static MicroserviceDotnetCoreModule getInstance() {
		return instance;
	}

	@Override
	public MicroserviceDotnetCorePeerModule getPeerModule() {
	 ...
	 */
	public MicroserviceDotnetCoreModule(IModuleContext moduleContext) {
		super(moduleContext);

		MicroserviceDotnetCoreModule.instance = this;

		this.lifeCycleHandler = new MicroserviceDotnetCoreLifeCycleHandler(this);
		this.peerModule = new MicroserviceDotnetCorePeerModule(this, moduleContext.getPeerConfiguration());
	}
