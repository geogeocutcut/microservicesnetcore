...
import org.modelio.microservicesnetcore.api.IMicroserviceDotnetCorePeerModule;
 ...
 *
 */
public class MicroserviceDotnetCorePeerModule implements IMicroserviceDotnetCorePeerModule {
    private MicroserviceDotnetCoreModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public MicroserviceDotnetCorePeerModule(MicroserviceDotnetCoreModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
