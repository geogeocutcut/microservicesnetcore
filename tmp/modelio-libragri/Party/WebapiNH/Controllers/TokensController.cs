...
namespace Libragri.PartyDomain.Webapi.Controllers
{
    ...
    public class TokensController : ControllerBase
    {
        ...
        public TokensController(IOptions<IdentityProviderSettings> settings,IUserDataService service,IUserRefreshTokenService refreshTokenService)
    	{
        ...
        private AuthenticationToken GenerateJwt(string clientId, UserData user, string refreshToken, int expireMinutes)

        {
...

            {
                ...
                new Claim("UserProfiles","["+user.Party.PartyRole.Select(p =>p.RoleEnum.ToString()).Aggregate(string.Empty,(p1,p2)=>{
